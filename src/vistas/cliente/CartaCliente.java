...
public class CartaCliente extends JPanel 
{
	...
	{   
	    ...
	    JLabel icono;
	    try {
	        icono = new JLabel(escalarImagen(this.cliente.getIneDireccion(), 250, 160));
	    } catch (Exception e) {
	        icono = new JLabel(escalarImagenLocal("..\\img\\LicenseDefault.png", 250, 160));
	    }
	    ...
	    boonPanel.setAlignmentX(Component.LEFT_ALIGNMENT);
	    ...
	    clienteInfoPanel.add(Box.createRigidArea(new Dimension(0, 5)));
	    ...
	    add(clienteInfoPanel, BorderLayout.CENTER);
	}
